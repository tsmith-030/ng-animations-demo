...
import {FullscreenLoaderOverlayComponent} from './fullscreen-loader-overlay.component';
import {MatProgressSpinnerModule} from '@angular/material';

fdescribe('Given FullscreenLoaderOverlayComponent', () => {
  let component: FullscreenLoaderOverlayComponent;
  let fixture: ComponentFixture<FullscreenLoaderOverlayComponent>;

  beforeEach(async(() => {
    TestBed.configureTestingModule({
      declarations: [FullscreenLoaderOverlayComponent],
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(FullscreenLoaderOverlayComponent);
